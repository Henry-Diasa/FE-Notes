...
<img src="img/http-proxy.jpg" style="zoom: 50%">
...
<img src="img/http-proxy2.jpg" style="zoom: 50%">
...
<img src="img/http-proxy3.jpg" style="zoom: 50%">

单从浏览器的页面上很难看出代理做了哪些工作，因为代理的转发都在后台不可见，所以我把这个过程用 Wireshark 抓了一个包：

<img src="img/http-proxy-wire.jpg" style="zoom: 50%">
...
```http
PROXY TCP$ 1.1.1.1 2.2.2.2 55555 80 \r\n
GET / HTTP/1.1 \r\n
Host: www.xxx.com \r\n
\r\n
```
...
<img src="img/http-proxy-cache.jpg" style="zoom: 50%">
...
服务器端的“Cache-Control”属性：max-age、no_store、no_cache 和 must-revalidate，这 4 种缓存属性可以约束客户端，也可以约束代理。
